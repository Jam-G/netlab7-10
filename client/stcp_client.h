...
int stcp_client_connect(int socked, int server_nodeID, unsigned int server_port);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
int timeval_subtract(struct timeval *diff, struct timeval *x, struct timeval *y);
#endif
