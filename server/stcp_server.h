...
typedef struct server_tcb {
	unsigned int server_nodeID;     //·þÎñÆ÷œÚµãID, ÀàËÆIPµØÖ·, ±ŸÊµÑéÎŽÊ¹ÓÃ
	unsigned int server_portNum;    //·þÎñÆ÷¶Ë¿ÚºÅ
	unsigned int client_nodeID;     //¿Í»§¶ËœÚµãID, ÀàËÆIPµØÖ·, ±ŸÊµÑéÎŽÊ¹ÓÃ
	unsigned int client_portNum;    //¿Í»§¶Ë¶Ë¿ÚºÅ
	unsigned int state;         	//·þÎñÆ÷×ŽÌ¬
	unsigned int expect_seqNum;     //·þÎñÆ÷ÆÚŽýµÄÊýŸÝÐòºÅ	
	char* recvBuf;                  //ÖžÏòœÓÊÕ»º³åÇøµÄÖžÕë
	unsigned int  usedBufLen;       //œÓÊÕ»º³åÇøÖÐÒÑœÓÊÕÊýŸÝµÄŽóÐ¡
	pthread_mutex_t* bufMutex;      //ÖžÏòÒ»žö»¥³âÁ¿µÄÖžÕë, žÃ»¥³âÁ¿ÓÃÓÚ¶ÔœÓÊÕ»º³åÇøµÄ·ÃÎÊ
