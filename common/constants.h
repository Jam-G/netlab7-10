...
//数据包丢失率为10%
#define PKT_LOSS_RATE 0.08
//SYN_TIMEOUT值, 单位为纳秒
#define SYN_TIMEOUT 600000000
//FIN_TIMEOUT值, 单位为纳秒
#define FIN_TIMEOUT 600000000
...
#define SENDBUF_POLLING_INTERVAL 600000000
...
#define ACCEPT_POLLING_INTERVAL 600000000
//接收缓冲区大小
#define RECEIVE_BUF_SIZE 1000000
//数据段超时值, 单位为纳秒
#define DATA_TIMEOUT 6000000
//GBN窗口大小
